...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <![endif]-->
    <script src="newJs/validUser.js"></script>
      ...
      <section class="login">
        <div class="container">
          <div class="col-md-6 col-md-offset-3 col-sm-6 col-xs-12">
            <form name="Form1" id="Form1" action="loginUserr.php" method="POST" onSubmit="return ValidateForm1(this)" enctype="multipart/form-data">
              <h2>Login</h2>
