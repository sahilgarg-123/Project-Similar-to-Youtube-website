...
function edToolbar(obj) {
	...
	document.write("<img class=\"button\" src=\"editor/images/h1.png\" name=\"btnlink\" title=\"Bold\" onClick=\"doH('<h1>','</h1>','" + obj + "')\">");
	document.write("<img class=\"button\" src=\"editor/images/h2.png\" name=\"btnlink\" title=\"Bold\" onClick=\"doH2('<h2>','</h2>','" + obj + "')\">");
	document.write("<img class=\"button\" src=\"editor/images/h3.png\" name=\"btnlink\" title=\"Bold\" onClick=\"doH3('<h3>','</h3>','" + obj + "')\">");
	document.write("<img class=\"button\" src=\"editor/images/h4.png\" name=\"btnlink\" title=\"Bold\" onClick=\"doH4('<h4>','</h4>','" + obj + "')\">");
