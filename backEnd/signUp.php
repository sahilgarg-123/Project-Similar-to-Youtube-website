            ...
            <form name="Form1" id="Form1" onSubmit="return ValidateForm1(this)">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                ...
                <input type="email" id="mail" name="mail" class="form-control" placeholder="Email ID">
              </div>
                <div class="form-group">
               
                <input type="text" id="adds" name="adds" class="form-control" placeholder="Address">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" id="cpwd" name="cpwd" class="form-control" placeholder="Confirm Password">
              </div>
