...
<head>
  ...
  <script src="js/addcatValid.js"></script>
    <script src="js/addCat.js"></script>
    <script src="js/addnewSubcat.js"></script>
    <script src="js/changeSeoSubcat.js"></script>
    <script src="js/saveNewsubCat.js"></script>
    <script src="js/rmainCat.js"></script>
    <script src="js/Validremovecat.js"></script>
    <script src="js/loadSubcat.js"></script>
    <script src="js/validForm4.js"></script>
    <script src="js/removeSubcat.js"></script>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="add_remove_video.php"><i class="fa fa-circle-o"></i> Add / Remove</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="add_new_image.php"><i class="fa fa-circle-o"></i> Add New Product</a></li>
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-6 col-sm-6 col-xs-12">
          <div class="form">
            <form class="remove sub-category" name="Form1" id="Form1" onsubmit="return ValidateForm1(this)">
            ...
            <form class="remove" name="Form2" id="Form2" onsubmit="return ValidateForm2(this)">
              <h2><i class="fa fa-plus"></i> ADD SUB CATEGORY</h2>
              <div class="form-group">
                <label class="control-label col-sm-3"> Category</label>
                <div class="col-sm-9">
                <select class="form-control" id="newCat" name="newCat" onChange="changenewCat(this.value)">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                <input type="text" name="newSubcat" id="newSubcat" class="form-control" placeholder="Sub Category">
                </div>
              </div>
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <div class="seo">
            ...
            <form class="green remove" name="Form3" id="Form3" onsubmit="return ValidateForm3(this)">
              <h2><i class="fa fa-remove"></i> Remove Category</h2>
            <div class="form-group">
                ...
                <select class="form-control" id="rcat" name="rcat">
                  ...
                  <?php
				  $csql="SELECT * FROM `formalCat`";
				  $cresult=mysqli_query($conn,$csql);
				  while($crow=mysqli_fetch_array($cresult))
				  {
				  ?>
                  <option value="<?php echo $crow['cat']; ?>"><?php echo $crow['cat']; ?></option>
                  <?php
				  }
				  ?>
            ...
            <form class="green remove" name="Form4" id="Form4" onSubmit="return ValidateForm4(this)">
              <h2><i class="fa fa-remove"></i> Remove Sub Category</h2>
            <div class="form-group">
                <label class="control-label col-sm-3"> Choose Category</label>
                <div class="col-sm-9">
                <select class="form-control" id="rcat1" name="rcat1" onChange="loadSubcat()">
                  <option selected="" selected>Select Category</option>
                  <?php
				  $dsql="SELECT * FROM `formalCat`";
				  $dresult=mysqli_query($conn,$dsql);
				  while($drow=mysqli_fetch_array($dresult))
				  {
				  ?>
                  <option value="<?php echo $drow['cat']; ?>"><?php echo $drow['cat']; ?></option>
                  <?php
				  }
				  ?>
