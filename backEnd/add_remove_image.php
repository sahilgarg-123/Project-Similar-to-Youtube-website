          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <p>
                  Mr. Pradeep sheoran(+919306488494) - Web Developer
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu active">
            ...
            <li class="active"><a href="add_remove_image.php"><i class="fa fa-circle-o"></i> Add / Remove</a></li>
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-6 col-sm-6 col-xs-12">
          <div class="form">
            <form class="remove sub-category">
            ...
            <form class="remove">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                <input type="email" class="form-control" placeholder="Sub Category">
                </div>
              </div>
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <div class="seo">
            ...
            <div class="form-group">
                <label class="control-label col-sm-3"> Choose Sub Category</label>
                <div class="col-sm-9">
                <input type="email" class="form-control" placeholder="Sub Category">
                </div>
              </div>
