...
<html style="height: auto; min-height: 100%;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <script src="js/callprod.js"></script>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <p>
                  Mr. Pradeep kumar sheoran(+919306488494,+917015505695)
  ...
  <div class="content-wrapper" style="min-height: 459px;">
    ...
    <section class="content">
      ...
      <div class="form-group">
                ...
                <div class="col-sm-4">
                <button class="btn btn-facebook" onClick="callprod()">Display</button>
                </div>
      ...
      <div class="row">
        ...
        <?php
		include("connect.php");
		$searchVideo="SELECT * FROM `product` WHERE cat='".$pri_cat."'";
		...
		?>
          <div class="col-md-2 col-sm-6 col-xs-12">
            <div class="sub-part">
              <figure><img src="<?php echo $svRow['url']; ?>" class="img-responsive"></figure>
              ...
              <h4><a href="" class="set" onClick="updateP('<?php echo $svRow['sr'];?>',<?php echo $svRow['priority']; ?>)">Priorty</a> <a href="#.html" class="remove">For Future</a> </h4>
            </div>
          </div>
          <?php
		}
