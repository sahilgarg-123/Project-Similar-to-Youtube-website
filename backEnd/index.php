...
<head>
  ...
  <title>Dashboard - Prabhu Bhakti</title>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="index.html"><i class="fa fa-circle-o"></i> Add New Sharing</a></li>
            <li><a href="index2.html"><i class="fa fa-circle-o"></i> Set Priority</a></li>
          </ul>
        </li>
